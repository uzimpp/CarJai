...
// AdminReportResponse represents the response format for admin reports (API response only)
...
// AdminReportsListResponse represents the response for admin reports list (API response only)
type AdminReportsListResponse struct {
	Reports []AdminReportResponse `json:"reports"`
	Total   int                   `json:"total"`
}

// ReportSubmitResponse represents the response for submitting a report (API response only)
