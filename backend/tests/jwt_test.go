...
func TestJWTManager_GenerateToken(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			req := utils.NewAdminTokenRequest(tt.adminID, tt.username, tt.sessionID)
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if !tt.wantErr {
				if claims.UserID != adminID {
					t.Errorf("JWTManager.ValidateToken() UserID = %v, want %v", claims.UserID, adminID)
				}
...
func TestExtractTokenFromHeader(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := utils.ExtractTokenFromHeader(tt.authHeader)
			if (err != nil) != tt.wantErr {
				t.Errorf("utils.ExtractTokenFromHeader() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("utils.ExtractTokenFromHeader() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestIsTokenExpired(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := utils.IsTokenExpired(tt.token)
			if (err != nil) != tt.wantErr {
				t.Errorf("utils.IsTokenExpired() error = %v, wantErr %v", err, tt.wantErr)
				return
			}
			if got != tt.want {
				t.Errorf("utils.IsTokenExpired() = %v, want %v", got, tt.want)
			}
		})
	}
}
